    ...
    public function run()
    {
        ...
        $data = [
            ...
            [
                ...
                'code'      => 'qris',
                'category'  => 'qris',
                'image'     => 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/QRIS_logo.svg/1200px-QRIS_logo.svg.png',
                'admin_fee' => 0,
                'is_active' => true,
            ],
            ...
            [
                ...
                'code'      => 'bni_va',
                'category'  => 'bank',
                'image'     => 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/LOGO_BNI_BARU.svg/2560px-LOGO_BNI_BARU.svg.png',
                'admin_fee' => 1000,
                'is_active' => true,
            ],
