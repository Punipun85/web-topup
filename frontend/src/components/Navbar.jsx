    ...
    <header className="bg-[#111111] border-b border-white/5 sticky top-0 z-50">
      <div className="max-w-[1400px] mx-auto px-4 h-16 flex items-center gap-6">
        ...
        <div className="flex-1 relative">
          ...
          <input
            type="text"
            className="w-full bg-[#1e1e1e] border border-gray-800 rounded-lg py-2 pl-11 text-sm text-white focus:outline-none"
        ...
        <div className="flex gap-4 items-center">
          <Link
            to="/login"
            className="flex items-center gap-2 text-xs font-bold hover:text-[#f3f305]"
          >
            <LogIn size={16} /> Masuk
          </Link>
